...
* [GraalVM Native Image Support](https://docs.spring.io/spring-boot/docs/3.2.7-SNAPSHOT/reference/html/native-image.html#native-image)
...
* [Configure AOT settings in Build Plugin](https://docs.spring.io/spring-boot/docs/3.2.7-SNAPSHOT/maven-plugin/reference/htmlsingle/#aot)
